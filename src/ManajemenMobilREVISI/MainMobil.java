...
public class MainMobil {
    ...
    static ManajerMobil manajerMobil = new ManajerMobil();
    static ManajerTravel manajerTravel = new ManajerTravel();
//    static Mobil[] daftarMobil = new Mobil[2]; 
    ...
    private static void menuAdmin() {
        ...
        while (opsi != 4) {
            ...
            switch (opsi) {
                ...
                case 3 -> {
                    System.out.print("Masukkan nomor plat untuk pencarian: ");
                    String noPlatDicari = sc.nextLine();
                    manajerMobil.cariNoPlatMobil(noPlatDicari);
                }
